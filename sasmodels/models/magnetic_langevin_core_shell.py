...
# def profile(sld_core, magnetic_sld_core, radius, sld_solvent, magnetic_sld_solvent, n, sld, magnetic_sld, thickness):
#     """
#     Returns the SLD profile *r* (Ang), and *rho* (1e-6/Ang^2).
#     """
#     n = int(n+0.5)
...
# #    return np.asarray(z), np.asarray(rho) , np.asarray(rho_mag)  
