...
source = ["lib/sas_3j1x_x.c",  "lib/kron.c", "lib/lookup_sin.c", "lib/lookup_cos.c", "integration/core_shell_ellipsoid2_integration.c","core_shell_ellipsoid2.c"]
have_Fq = True
