...
name = "flexible_cylinder_elliptical2"
...
source = ["lib/polevl.c", "lib/sas_J1.c", "lib/kron.c", "lib/lookup_sin.c", "lib/lookup_cos.c", "integration/elliptical_crosssection2_integration.c", "lib/wrc_cyl.c",
          "flexible_cylinder_elliptical2.c"]
