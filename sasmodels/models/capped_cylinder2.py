...
source = ["lib/polevl.c", "lib/sas_J1.c", "lib/kron.c", "lib/lookup_sin.c", "lib/lookup_cos.c", "integration/capped_cylinder2_kernel_integration.c", "integration/capped_cylinder2_integration.c","capped_cylinder2.c"]
