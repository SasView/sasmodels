...
source = ["lib/polevl.c", "lib/sas_J1.c", "lib/kron.c", "lib/lookup_sin.c", "lib/lookup_cos.c", "integration/hollow_cylinder2_integration.c", "hollow_cylinder2.c"]
have_Fq = True
